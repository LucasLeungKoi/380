...
public class UserManagementService {
    ...
    @Transactional
    public void createTicketUser(String username, String password, String phone, String email, String[] roles) {
        TicketUser user = new TicketUser(username, password, phone, email, roles);
        tuRepo.save(user);
    }
}